function stationLogin(context, payload) {
  ...
  // If the station is locked or the player is unable to do anything they shouldn't
  // be able to log into the station
  ...
  const loginTime = ((stationObj.properties.loginTime * stationObj.properties.loginMultiplier)
