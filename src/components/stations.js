function Stations(el, context) {
  ...
  el.className = "station-master-div";
  ...
  game.stations.forEach((station, i) => {
    ...
    const div = document.createElement('div');
      ...
      div.className = ((i === 1) || (i === 4)) ? "station-lower " + station.name : "station-upper " + station.name;
    ...
    function setSelectable(s) {
      ...
      if (s) {
        ...
        div.classList.add("station-selectable");

        div.style.border = "solid green";

      } else {

        div.classList.remove("station-selectable");
    ...
    div.subscribe('station:login:wait', (e) => {
      ...
      loginInterval = context.setInterval(() => {
        ...
        div.textContent = `(Logging in ${sec}s)`;
